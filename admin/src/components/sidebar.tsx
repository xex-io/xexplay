...
const navSections: NavSection[] = [
  {
    items: [
      ...
      { label: "Matches", href: "/matches", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
      ...
      { label: "Baskets", href: "/baskets", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
      ...
      { label: "Leaderboards", href: "/leaderboards", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
      { label: "Rewards", href: "/rewards", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
      { label: "Prize Pools", href: "/prize-pools", icon: "M12 8v13m0-13V6a4 4 0 00-4-4H6a2 2 0 00-2 2v2h4m4 4h8m-8 0H4m16 0v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Translations", href: "/translations", icon: "M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" },
      { label: "Moderation", href: "/moderation", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" },
      { label: "Abuse Flags", href: "/abuse", icon: "M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" },
